"""Add happiness fields to ChatMessage

Revision ID: bf9e549247e6
Revises: dc587b1ae37a
Create Date: 2026-02-04 13:01:06.618115
...
revision: str = "bf9e549247e6"
down_revision: Union[str, None] = "dc587b1ae37a"
...
def upgrade() -> None:
    ...
    # Drop Celery Beat tables if they exist (safe for both fresh and existing databases)
    bind = op.get_bind()
    ...
    op.add_column("chatmessage", sa.Column("happiness_delta", sa.Float(), nullable=True))
    op.add_column(
        "chatmessage", sa.Column("happiness_reason", sqlmodel.sql.sqltypes.AutoString(length=255), nullable=True)
    )
...
def downgrade() -> None:
    # ### commands auto generated by Alembic - please adjust! ###
    op.drop_column("chatmessage", "happiness_reason")
    op.drop_column("chatmessage", "happiness_delta")
    op.create_table(
        "celery_clockedschedule",
