...
// Mock @nuxt/ui UTooltip to avoid TooltipProvider dependency
// Mock @nuxt/ui Tooltip to avoid TooltipProvider dependency
...
describe('ResourceBar', () => {
  describe('Props', () => {
    it('should render with required props', () => {
      const wrapper = mount(ResourceBar, { props: { current: 50, max: 100, icon: 'mdi:lightning-bolt' } })
      expect(wrapper.exists()).toBe(true)
      expect(wrapper.text()).toContain('50/100')
    })

    it('should display correct current and max values', () => {
      const wrapper = mount(ResourceBar, { props: { current: 75, max: 150, icon: 'mdi:water' } })
  ...
  describe('Percentage Calculation', () => {
    ...
    it('should handle 0% correctly', () => {
      const wrapper = mount(ResourceBar, { props: { current: 0, max: 100, icon: 'mdi:lightning-bolt' } })
      const progressBar = wrapper.find('.transition-all')
      expect(progressBar.attributes('style')).toContain('width: 0%')
    })

    it('should handle 100% correctly', () => {
      const wrapper = mount(ResourceBar, { props: { current: 100, max: 100, icon: 'mdi:lightning-bolt' } })
      const progressBar = wrapper.find('.transition-all')
      expect(progressBar.attributes('style')).toContain('width: 100%')
    })

    it('should cap at 100% when current exceeds max', () => {
      const wrapper = mount(ResourceBar, { props: { current: 150, max: 100, icon: 'mdi:lightning-bolt' } })
      const progressBar = wrapper.find('.transition-all')
      expect(progressBar.attributes('style')).toContain('width: 100%')
    })

    it('should calculate fractional percentages correctly', () => {
      const wrapper = mount(ResourceBar, { props: { current: 33, max: 100, icon: 'mdi:lightning-bolt' } })
      const progressBar = wrapper.find('.transition-all')
  ...
  describe('Icon Rendering', () => {
    ...
    it('should pass icon prop to Icon component', () => {
      const wrapper = mount(ResourceBar, { props: { current: 50, max: 100, icon: 'mdi:water' } })
  ...
  describe('Styling', () => {
    ...
    it('should display text overlay with values', () => {
      const wrapper = mount(ResourceBar, { props: { current: 75, max: 100, icon: 'mdi:lightning-bolt' } })
  ...
  describe('Status Colors', () => {
    it('should show red color for critical status (<=5%)', () => {
      const wrapper = mount(ResourceBar, { props: { current: 5, max: 100, icon: 'mdi:lightning-bolt' } })
      const progressBar = wrapper.find('.transition-all')
    ...
    it('should show orange color for low status (<=20%)', () => {
      const wrapper = mount(ResourceBar, { props: { current: 20, max: 100, icon: 'mdi:lightning-bolt' } })
      const progressBar = wrapper.find('.transition-all')
  ...
  describe('Edge Cases', () => {
    it('should handle zero max value', () => {
      const wrapper = mount(ResourceBar, { props: { current: 0, max: 0, icon: 'mdi:lightning-bolt' } })
    ...
    it('should handle large numbers', () => {
      const wrapper = mount(ResourceBar, { props: { current: 9999, max: 10000, icon: 'mdi:lightning-bolt' } })
    ...
    it('should handle negative current value gracefully', () => {
      const wrapper = mount(ResourceBar, { props: { current: -10, max: 100, icon: 'mdi:lightning-bolt' } })
  ...
  describe('Label', () => {
    it('should display label when provided', () => {
      const wrapper = mount(ResourceBar, { props: { current: 50, max: 100, icon: 'mdi:lightning-bolt', label: 'Power' } })
