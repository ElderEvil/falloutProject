...
<template>
  ...
  >
      ...
      <div class="flex flex-1 flex-col justify-center">
        ...
        <div class="flex flex-col gap-1">
          <div class="flex items-center gap-2">
            ...
            <div
              class="h-4 flex-1 overflow-hidden rounded-[3px] border border-theme-primary/40 bg-terminal-background"
            >
              <div
    ...
    <div class="mb-4">
      ...
      <div
        class="mb-2 h-7 overflow-hidden rounded-md border-2 border-theme-primary bg-terminal-background"
      >
        <div
