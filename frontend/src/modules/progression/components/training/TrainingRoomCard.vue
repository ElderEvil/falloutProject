...
<template>
  <div
    class="flex items-stretch gap-4 rounded-lg border-2 border-theme-primary bg-transparent p-4 shadow-[0_0_10px_var(--color-theme-glow)] transition-all duration-200 hover:border-theme-primary hover:shadow-[0_0_15px_var(--color-theme-glow)]"
  >
    <div
    ...
    <div class="flex min-w-0 flex-1 flex-col gap-3">
      ...
      <div class="flex flex-col gap-1.5">
        ...
        <div class="flex gap-1.5" :aria-label="`${occupancyLabel} training spaces occupied`" role="img">
          <span
            v-for="(isFilled, index) in occupancySlots"
            :key="index"
            class="occupancy-slot h-2.5 flex-1 rounded-sm border border-theme-primary/35"
