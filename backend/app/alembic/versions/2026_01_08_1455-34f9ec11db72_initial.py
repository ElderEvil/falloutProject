...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column(
            "category",
            sa.Enum("CAPACITY", "CRAFTING", "MISC", "PRODUCTION", "QUESTS", "THEME", "TRAINING", name="roomtypeenum"),
            nullable=False,
        ),
        sa.Column(
            "ability",
            sa.Enum(
                "STRENGTH", "PERCEPTION", "ENDURANCE", "CHARISMA", "INTELLIGENCE", "AGILITY", "LUCK", name="specialenum"
            ),
            nullable=True,
        ),
    ...
    op.create_table(
        ...
        sa.Column(
            "status",
            sa.Enum("IDLE", "WORKING", "EXPLORING", "TRAINING", "RESTING", "DEAD", name="dwellerstatusenum"),
            nullable=False,
        ),
        sa.Column("id", sa.Uuid(), nullable=False),
        sa.Column("vault_id", sa.Uuid(), nullable=False),
    ...
    op.create_table(
        ...
        sa.Column(
            "status", sa.Enum("ACTIVE", "SPREADING", "RESOLVED", "FAILED", name="incidentstatus"), nullable=False
        ),
    ...
    op.create_table(
        ...
        sa.Column(
            "junk_type",
            sa.Enum("CIRCUITRY", "LEATHER", "ADHESIVE", "CLOTH", "SCIENCE", "STEEL", "VALUABLES", name="junktypeenum"),
            nullable=False,
        ),
    ...
    op.create_table(
        ...
        sa.Column(
            "relationship_type",
            sa.Enum("ACQUAINTANCE", "FRIEND", "ROMANTIC", "PARTNER", "EX", name="relationshiptypeenum"),
            nullable=False,
        ),
...
def downgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column(
            "enabled", sa.BOOLEAN(), autoincrement=False, nullable=False, comment="Set to False to disable the schedule"
        ),
        sa.Column(
            "last_run_at",
            postgresql.TIMESTAMP(timezone=True),
    ...
    op.create_table(
        ...
        sa.UniqueConstraint(
            "event", "latitude", "longitude", name=op.f("celery_solarschedule_event_latitude_longitude_key")
        ),
    )
    op.create_table(
