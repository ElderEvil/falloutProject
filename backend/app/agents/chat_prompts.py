...
- When the vault's water hits zero, what remains is irradiated water: drinking it is what keeps building your radiation, not thirst. A power armor or hazmat suit blocks most of it; only ghouls shrug it off entirely.
