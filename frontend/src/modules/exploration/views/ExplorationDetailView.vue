...
const dweller = computed(() => {
    ...
    return dwellerStore.dwellers.find(
        (d) => d.id === exploration.value!.dweller_id,
    );
});
...
const hasNext = computed(
    () => currentIndex.value < allExplorations.value.length - 1,
);
...
const navigatePrevious = () => {
    if (hasPrevious.value) {
        ...
        router.push(
            `/vault/${vaultId.value}/exploration/${prevExploration!.id}`,
        );
    }
};
...
const navigateNext = () => {
    if (hasNext.value) {
        ...
        router.push(
            `/vault/${vaultId.value}/exploration/${nextExploration!.id}`,
        );
    }
};
...
onMounted(async () => {
    ...
    pollInterval = setInterval(async () => {
        if (explorationId.value && authStore.token) {
            ...
            await explorationStore.fetchExplorationDetails(
                explorationId.value,
                authStore.token,
            );
        }
                            ...
                            <div class="stat-bar">
                                ...
                                <div class="stat-bar-bg">
                                    <div
                                        ...
                                        :style="{
                                            width: `${(dweller.health / dweller.max_health) * 100}%`,
                                        }"
                                    ></div>
                                </div>
                    ...
                    <div v-else class="event-list">
                        ...
                        >
                            <span class="event-time">{{
                                formatEventTime(event.time_elapsed_hours)
                            }}</span>
                            <Icon
            ...
            <div class="equipment-section">
                <div class="equipment-slot">
                    ...
                    <div class="equipment-info">
                        ...
                        <span class="equipment-value">{{
                            dweller && "weapon" in dweller
                                ? dweller.weapon?.name || "Unarmed"
                                : "Unarmed"
                        }}</span>
                    </div>
                </div>
                <div class="equipment-slot">
                    ...
                    <div class="equipment-info">
                        ...
                        <span class="equipment-value">{{
                            dweller && "outfit" in dweller
                                ? dweller.outfit?.name || "Vault Suit"
                                : "Vault Suit"
                        }}</span>
                    </div>
                </div>
