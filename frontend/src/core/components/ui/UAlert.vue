...
const variantClasses = {
  success:
    'bg-[color:var(--color-theme-primary)]/10 border-[color:var(--color-theme-primary)] text-[color:var(--color-theme-primary)]',
  warning:
    'bg-[color:var(--color-warning)]/10 border-[color:var(--color-warning)] text-[color:var(--color-warning)]',
  danger:
    'bg-[color:var(--color-danger)]/10 border-[color:var(--color-danger)] text-[color:var(--color-danger)]',
