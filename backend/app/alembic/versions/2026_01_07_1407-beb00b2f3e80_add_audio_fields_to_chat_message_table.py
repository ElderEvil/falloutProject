"""Add audio fields to chat_message table

Revision ID: beb00b2f3e80
Revises: 5b4c07ac82f0
Create Date: 2026-01-07 14:07:42.888793
...
revision: str = 'beb00b2f3e80'
down_revision: Union[str, None] = '5b4c07ac82f0'
...
def upgrade() -> None:
    ...
    op.add_column('chatmessage', sa.Column('audio_url', sqlmodel.sql.sqltypes.AutoString(length=500), nullable=True))
    op.add_column('chatmessage', sa.Column('transcription', sqlmodel.sql.sqltypes.AutoString(length=2000), nullable=True))
    op.add_column('chatmessage', sa.Column('audio_duration', sa.Float(), nullable=True))
    # ### end Alembic commands ###


def downgrade() -> None:
    # ### commands auto generated by Alembic - please adjust! ###
    op.drop_column('chatmessage', 'audio_duration')
    op.drop_column('chatmessage', 'transcription')
    op.drop_column('chatmessage', 'audio_url')
