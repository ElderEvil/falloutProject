    ...
    <div class="min-h-screen bg-black py-8 px-4 font-mono">
        <div class="max-w-7xl mx-auto">
            ...
            <div class="mb-8">
                ...
                <p
                    class="text-theme-primary/60 mt-2 uppercase tracking-wider text-sm"
                >
            ...
            >
                <Icon
                    icon="mdi:loading"
                    class="h-12 w-12 animate-spin text-theme-primary mx-auto"
                />
                <div class="text-xl text-theme-primary mt-4">
                    Loading profile...
                </div>
            </div>
