...
* replace the admin incident toggles with a CSRF-protected POST page 94571d9
...
* load outfits in the resource tick without per-dweller queries 3f456b5
...
* make vault ownership checks single-source and revive flow one path df90d00
...
* **storage:** report over-capacity instead of 500 ([#610](https://github.com/ElderEvil/falloutProject/issues/610)) fcc1a4c
...
* **rewards:** single reward contract plus lunchbox open mechanic ([#605](https://github.com/ElderEvil/falloutProject/issues/605)) 39781f7
...
* **vault:** seed new vaults on the unit grid with a stacked elevator shaft ([#597](https://github.com/ElderEvil/falloutProject/issues/597)) fe713d2
...
* **map:** polish fixes, hand-drawn trails, and map-module cleanup ([#593](https://github.com/ElderEvil/falloutProject/issues/593)) 001f82d
