...
Revision ID: 9a28b3c0e741
Revises: edb81af809b0
Create Date: 2026-01-03 17:20:38.383168
...
revision: str = '9a28b3c0e741'
down_revision: Union[str, None] = 'edb81af809b0'
...
def upgrade() -> None:
    ...
    op.drop_constraint(op.f('dweller_room_id_fkey'), 'dweller', type_='foreignkey')
    op.drop_constraint(op.f('dweller_vault_id_fkey'), 'dweller', type_='foreignkey')
    op.create_foreign_key(None, 'dweller', 'vault', ['vault_id'], ['id'], ondelete='CASCADE')
    op.create_foreign_key(None, 'dweller', 'room', ['room_id'], ['id'], ondelete='SET NULL')
    op.drop_constraint(op.f('incident_room_id_fkey'), 'incident', type_='foreignkey')
    op.drop_constraint(op.f('incident_vault_id_fkey'), 'incident', type_='foreignkey')
    op.create_foreign_key(None, 'incident', 'room', ['room_id'], ['id'], ondelete='CASCADE')
    op.create_foreign_key(None, 'incident', 'vault', ['vault_id'], ['id'], ondelete='CASCADE')
...
def downgrade() -> None:
    ...
    op.drop_constraint(None, 'incident', type_='foreignkey')
    op.create_foreign_key(op.f('incident_vault_id_fkey'), 'incident', 'vault', ['vault_id'], ['id'])
    op.create_foreign_key(op.f('incident_room_id_fkey'), 'incident', 'room', ['room_id'], ['id'])
    op.drop_constraint(None, 'dweller', type_='foreignkey')
    op.drop_constraint(None, 'dweller', type_='foreignkey')
    op.create_foreign_key(op.f('dweller_vault_id_fkey'), 'dweller', 'vault', ['vault_id'], ['id'])
    op.create_foreign_key(op.f('dweller_room_id_fkey'), 'dweller', 'room', ['room_id'], ['id'])
