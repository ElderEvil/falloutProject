...
**Discovery unlock fix (v2.46.0 follow-up):** shipped with the next release. `register_discovery` now links the
...
(`scripts/backfill_unlock_discoveries.py`) repairs pre-fix rows.
